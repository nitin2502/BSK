...
public class LoginBSk2 {
	...
	public void loginWithValidCredentials() throws InterruptedException {
		...
		try {
			Assert.assertTrue(driver.getCurrentUrl().contains("dashboargh"), "Login Successful");
			test.log(Status.PASS, "Login with valid credentials was successful.");
		} catch (AssertionError e) {
			test.log(Status.FAIL, "Login failed: " + e.getMessage());
			test.addScreenCaptureFromPath(takeScreenshot("TC01_Failure"));
			throw e;
		}
	}
	...
	public void loginWithInvalidCredentials() throws InterruptedException {
		...
		driver.navigate().refresh();
		driver.findElement(By.id("mat-input-0")).sendKeys("sar@0");
		driver.findElement(By.id("mat-input-1")).sendKeys("Admin@1234");
		driver.findElement(By.xpath("//button[@type='submit'][1]")).click();
		...
		try {
			...
			test.addScreenCaptureFromPath(takeScreenshot("TC02_Failure"));
			throw e;
		}
	}
	...
	public void loginWithEmptyFields() throws InterruptedException {
		...
		try {
			...
			test.addScreenCaptureFromPath(takeScreenshot("TC03_Failure"));
			throw e;
		}
	}
	...
	public void loginWithOnlyEmailEntered() throws InterruptedException {
		...
		try {
			...
			test.addScreenCaptureFromPath(takeScreenshot("TC04_Failure"));
			throw e;
		}
	}
	...
	public void loginWithOnlyPasswordEntered() throws InterruptedException {
		...
		try {
			...
			test.log(Status.FAIL, "Email field validation failed: " + e.getMessage());
			test.addScreenCaptureFromPath(takeScreenshot("TC05_Failure"));
			throw e;
		}
	}
	...
	public void loginWithSpecialCharacters() throws InterruptedException {
		...
		try {
			...
			test.log(Status.FAIL, "Error message for special characters is incorrect: " + e.getMessage());
			test.addScreenCaptureFromPath(takeScreenshot("TC06_Failure"));
			throw e;
		}
	}
	...
	public void loginButtonIsClickable() throws InterruptedException {
		...
		try {
			Assert.assertTrue(loginButton.isEnabled(), "Login button is clickable");
			test.pass("Login button is clickable.");
		} catch (AssertionError e) {
			test.log(Status.FAIL, "Login button not clickable: " + e.getMessage());
			test.addScreenCaptureFromPath(takeScreenshot("TC07_Failure"));
			throw e;
		}
	}
	...
	private String takeScreenshot(String testName) {
		// Generate screenshot name using testName
